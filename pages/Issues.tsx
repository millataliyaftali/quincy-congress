...
const Issues: React.FC = () => {
  const fightingPoints = [
    {
      bold: "Put people over corporate greed",
      regular: " by capping prescription drug prices and health insurance premiums — so every family and senior can afford the care they need."
    },
    {
    ...
    {
      bold: "Increase affordable housing",
      regular: " by strengthening housing supply laws to stop Wall Street from hoarding housing and capping corporate rent gouging."
    },
    {
      bold: "Reduce prices",
      regular: " by enforcing antitrust rules against price-fixing corporate monopolies in groceries and energy, delivering faster relief at the checkout and at the gas pump."
    },
    {
      bold: "Lower electrical bills",
      regular: " by boosting clean energy incentives and grid upgrades and promoting solar, storage, and efficient transmission."
    }
  ];
            ...
            <div id="protecting-families" className="scroll-mt-32 grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 items-center">
              ...
              <div className="order-1 lg:order-2 relative">
                <div className="border-[8px] md:border-[12px] border-brand-navy shadow-[16px_16px_0px_0px_#e1bb23] lg:shadow-[32px_32px_0px_0px_#e1bb23] overflow-hidden h-[350px] md:h-[500px] lg:h-[650px]">
                  <img src="http://quincyforcongress.zahidyaftali.com/wp-content/uploads/2026/02/Protecting-our-families-as9-3807-1.jpg" alt="Health Care" className="w-full h-full object-cover block" />
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="order-2 lg:order-1 relative">
                <div className="border-[12px] border-brand-navy shadow-[16px_16px_0px_0px_#e1bb23] md:shadow-[32px_32px_0px_0px_#e1bb23] overflow-hidden h-[300px] md:h-[500px]">
                  <img src="http://quincyforcongress.zahidyaftali.com/wp-content/uploads/2026/02/Protecting-our-families-as9-3807-1.jpg" alt="Join Us" className="w-full h-full object-cover block" style={{ objectPosition: 'center center' }} />
                </div>
            </div>
